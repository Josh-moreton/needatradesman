...
const logger = createLogger('tradesperson-payouts');

// Feature flag - set to false to enable payouts feature
const PAYOUTS_COMING_SOON = process.env.NEXT_PUBLIC_PAYOUTS_DISABLED !== 'false';
...
export default function PayoutsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 relative">
      ...
      {/* Coming Soon Overlay - Remove or set NEXT_PUBLIC_PAYOUTS_DISABLED=false to enable */}
      {PAYOUTS_COMING_SOON && (
